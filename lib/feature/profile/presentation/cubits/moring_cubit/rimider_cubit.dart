...
class RimiderMoringCubit extends Cubit<RiminderState> {
  RimiderMoringCubit() : super(RiminderState(isNotificationActive: Hive.box("setting").get("moringAzkar",defaultValue: true)));
  ...
  isOn!=isOn;
  Hive.box("setting").put("moringAzkar", isOn);
  if(isOn==false){
    NotificationServices.cancleAllNotification(0);
  }
