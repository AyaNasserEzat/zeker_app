      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          leading: IconButton(onPressed: (){
            context.pop();
          }, icon: Icon(Icons.arrow_back_ios_new_sharp,color: AppColors.white,)),
          backgroundColor: AppColors.primaryColor,
          centerTitle: true, title: Text(widget.item.category,style: TextStyle(color: AppColors.white),)),
        body: ListView.separated(
          itemBuilder: (context, index) {
            return CustomCardItem(item: widget.item.array[index]);
          },
